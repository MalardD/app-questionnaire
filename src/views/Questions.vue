        ...
        return {
         ...
         //Voir la méthode ci-dessosu.
          questions: [ 
            ...
            {libelle: 'Quel est le prénom du président Hollande ?', optionReponse: ['François' , 'Nicolas' , 'Stéphane'], reponse: [], bonneRep: 'François' },
            {libelle: 'Combien font 4 + 5 * 2 ?', optionReponse: ['18' , '14' , 'Trop compliqué'], reponse: [], bonneRep: '14' },
            {libelle: 'Quel est la couleur du cheval blanc de Heri IV ?', optionReponse: ['blanc' , 'noir' , 'vert'], reponse: [], bonneRep: 'blanc' },
            {libelle: 'Quel joueur de football a déja mordu ces adversaires ?', optionReponse: ['Crisitiano Ronaldo' , 'Lionel Messi' , 'Luis Suárez'], reponse: [], bonneRep: 'Luis Suárez' },
            {libelle: 'Quel joueur de football a volontairement donné un coup de tête à son adversaire ?', optionReponse: ['Olivier Giroud' , 'N\'Golo Kanté' , 'Zinédine Zidane'], reponse: [], bonneRep: 'Zinédine Zidane' },
            {libelle: 'Qu\'est ce que la Guerre Froide ?', optionReponse: ['La guerre pendant l\'hiver' , 'Un conflit sans arme' ], reponse: [], bonneRep: 'Un conflit sans arme' },
            {libelle: 'Avez-vous aimez ce questionnaire ?', optionReponse: ['oui' , 'non'], reponse: [], bonneRep: 'oui' },
